...
#ifndef THIRD_PARTY_GLOOP_BASE_STRTOINT_H_
#define THIRD_PARTY_GLOOP_BASE_STRTOINT_H_
...
inline int32_t atoi32(const char* nptr) { return strto32(nptr, nullptr, 10); }

inline int64_t atoi64(const char* nptr) { return strto64(nptr, nullptr, 10); }

// Convenience versions of the above that take a string argument.
inline int32_t atoi32(const std::string& s) { return atoi32(s.c_str()); }

inline int64_t atoi64(const std::string& s) { return atoi64(s.c_str()); }

#endif  // THIRD_PARTY_GLOOP_BASE_STRTOINT_H_
