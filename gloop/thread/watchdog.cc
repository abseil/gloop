...
// Support for external watchdog adjustment. We use a weak symbol
// so that this library does not depend on the adjustment library directly.
// This function is overridden by the adjustment library if linked.
ABSL_ATTRIBUTE_WEAK void InitMigrationWatchdogAdjust() {}
