...
#ifndef THIRD_PARTY_GLOOP_UTIL_FLOATOPS_CASTOPS_H_
#define THIRD_PARTY_GLOOP_UTIL_FLOATOPS_CASTOPS_H_
...
template <typename FloatType>
signed char ToSchar(FloatType value) {
  return internal::ToSmallIntegral<FloatType, signed char>(value);
}

template <typename FloatType>
unsigned char ToUchar(FloatType value) {
  return internal::ToSmallIntegral<FloatType, unsigned char>(value);
}

}  // namespace x86compatible
}  // namespace util

#endif  // THIRD_PARTY_GLOOP_UTIL_FLOATOPS_CASTOPS_H_
