...
#ifndef THIRD_PARTY_GLOOP_UTIL_TASK_STATUS_INTERNAL_H_
#define THIRD_PARTY_GLOOP_UTIL_TASK_STATUS_INTERNAL_H_
...
#endif  // THIRD_PARTY_GLOOP_UTIL_TASK_STATUS_INTERNAL_H_
