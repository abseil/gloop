...
#ifndef THIRD_PARTY_GLOOP_UTIL_TASK_STATUS_MACROS_H_
#define THIRD_PARTY_GLOOP_UTIL_TASK_STATUS_MACROS_H_
...
#include "gloop/util/task/status_builder.h"  // IWYU pragma: export
...
#endif  // THIRD_PARTY_GLOOP_UTIL_TASK_STATUS_MACROS_H_
