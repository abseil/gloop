...
#ifndef THIRD_PARTY_GLOOP_UTIL_INTOPS_STRONG_VECTOR_H_
#define THIRD_PARTY_GLOOP_UTIL_INTOPS_STRONG_VECTOR_H_
...
class StrongVector : protected std::vector<NativeType, Alloc> {
 ...
 public:
  constexpr StrongVector() = default;
...
#endif  // THIRD_PARTY_GLOOP_UTIL_INTOPS_STRONG_VECTOR_H_
