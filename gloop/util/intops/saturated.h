...
#ifndef THIRD_PARTY_GLOOP_UTIL_INTOPS_SATURATED_H_
#define THIRD_PARTY_GLOOP_UTIL_INTOPS_SATURATED_H_
...
class Saturated {
 public:
  ...
  // Value. Lower case version also provided since this is the standard
  // spelling.
...
#endif  // THIRD_PARTY_GLOOP_UTIL_INTOPS_SATURATED_H_
