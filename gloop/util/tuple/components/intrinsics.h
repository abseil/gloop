...
//
// Definitions of primitive tuple operations such as size and element access.

// IWYU pragma: private, include "util/tuple/intrinsics.h"

#ifndef THIRD_PARTY_GLOOP_UTIL_TUPLE_COMPONENTS_INTRINSICS_H_
#define THIRD_PARTY_GLOOP_UTIL_TUPLE_COMPONENTS_INTRINSICS_H_
...
// used with algorithms defined in //gloop/util/tuple. These are the only
// extension points of the library, nothing else can be specialized. Do not use
// these classed directly, use the facades defined below: assemble, size,
// element, get, etc.
...
template <::size_t N, class T>
constexpr const char* name(unsigned rank) {
  return nullptr;
}
...
constexpr ::size_t index_of() {
  return internal_intrinsics::index_of<Elem, T>{};
}
...
#endif  // THIRD_PARTY_GLOOP_UTIL_TUPLE_COMPONENTS_INTRINSICS_H_
