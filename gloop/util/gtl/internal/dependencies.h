...
#ifndef THIRD_PARTY_GLOOP_UTIL_GTL_INTERNAL_DEPENDENCIES_H_
#define THIRD_PARTY_GLOOP_UTIL_GTL_INTERNAL_DEPENDENCIES_H_

#include <type_traits>

namespace gtl::internal_dependencies {
...
#endif  // THIRD_PARTY_GLOOP_UTIL_GTL_INTERNAL_DEPENDENCIES_H_
