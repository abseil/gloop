...
#ifndef THIRD_PARTY_GLOOP_UTIL_GTL_INTERNAL_NUM_INITIALIZERS_H_
#define THIRD_PARTY_GLOOP_UTIL_GTL_INTERNAL_NUM_INITIALIZERS_H_
...
#endif  // THIRD_PARTY_GLOOP_UTIL_GTL_INTERNAL_NUM_INITIALIZERS_H_
