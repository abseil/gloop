...
#ifndef THIRD_PARTY_GLOOP_UTIL_GTL_EXTEND_INTERNAL_REFLECTION_H_
#define THIRD_PARTY_GLOOP_UTIL_GTL_EXTEND_INTERNAL_REFLECTION_H_
...
#endif  // THIRD_PARTY_GLOOP_UTIL_GTL_EXTEND_INTERNAL_REFLECTION_H_
