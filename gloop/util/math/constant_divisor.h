...
#ifndef THIRD_PARTY_GLOOP_UTIL_MATH_CONSTANT_DIVISOR_H_
#define THIRD_PARTY_GLOOP_UTIL_MATH_CONSTANT_DIVISOR_H_
...
#endif  // THIRD_PARTY_GLOOP_UTIL_MATH_CONSTANT_DIVISOR_H_
