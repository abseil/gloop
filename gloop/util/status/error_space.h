...
#ifndef THIRD_PARTY_GLOOP_UTIL_STATUS_ERROR_SPACE_H_
#define THIRD_PARTY_GLOOP_UTIL_STATUS_ERROR_SPACE_H_
...
#endif  // THIRD_PARTY_GLOOP_UTIL_STATUS_ERROR_SPACE_H_
